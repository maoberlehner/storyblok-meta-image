...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/storyblok-meta-image
   # Navigate to the newly cloned directory
   cd storyblok-meta-image
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/maoberlehner/storyblok-meta-image
...
[already been reported]: https://github.com/maoberlehner/storyblok-meta-image/issues
[fork this project]:     https://github.com/maoberlehner/storyblok-meta-image/fork
